...
class Exercise1 extends Component {
  ...
  render() {
    return (
      <div >
        <button onClick={this.shiftImageBack} className="back">Back</button>
        <img src={this.state.images[this.state.currentImg] }alt="bashar"/>
        <button onClick={this.shiftImageForward} className="forward">Forward</button>
